...
const songs_module_1 = __webpack_require__(11);
const logger_middleware_1 = __webpack_require__(26);
const songs_controller_1 = __webpack_require__(12);
...
const playlist_module_1 = __webpack_require__(48);
const artist_module_1 = __webpack_require__(44);
const data_source_1 = __webpack_require__(51);
const seed_module_1 = __webpack_require__(54);
const config_1 = __webpack_require__(53);
const configuration_1 = __webpack_require__(58);
const env_validation_1 = __webpack_require__(59);
...
const common_1 = __webpack_require__(6);
const songs_controller_1 = __webpack_require__(12);
const songs_service_1 = __webpack_require__(13);
const typeorm_1 = __webpack_require__(20);
const song_entity_1 = __webpack_require__(15);
const artist_entity_1 = __webpack_require__(16);
...
const common_1 = __webpack_require__(6);
const songs_service_1 = __webpack_require__(13);
const create_song_dto_1 = __webpack_require__(22);
const update_song_dto_1 = __webpack_require__(24);
const artist_jwt_guard_1 = __webpack_require__(25);
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof create_song_dto_1.CreateSongDTO !== "undefined" && create_song_dto_1.CreateSongDTO) === "function" ? _b : Object, Object]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, typeof (_g = typeof update_song_dto_1.UpdateSongDTO !== "undefined" && update_song_dto_1.UpdateSongDTO) === "function" ? _g : Object]),
    __metadata("design:returntype", typeof (_h = typeof Promise !== "undefined" && Promise) === "function" ? _h : Object)
], SongsController.prototype, "updateSong", null);
exports.SongsController = SongsController = __decorate([
    (0, common_1.Controller)('songs'),
    __metadata("design:paramtypes", [typeof (_a = typeof songs_service_1.SongsService !== "undefined" && songs_service_1.SongsService) === "function" ? _a : Object])
], SongsController);
...
exports.Song = void 0;
const artist_entity_1 = __webpack_require__(16);
const playlist_entity_1 = __webpack_require__(19);
const typeorm_1 = __webpack_require__(14);
let Song = class Song {
};
exports.Song = Song;
...
__decorate([
    ...
    __metadata("design:type", typeof (_c = typeof playlist_entity_1.Playlist !== "undefined" && playlist_entity_1.Playlist) === "function" ? _c : Object)
...
], User.prototype, "enable2FA", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", typeof (_a = typeof Date !== "undefined" && Date) === "function" ? _a : Object)
], CreateSongDTO.prototype, "releasedDate", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ArtistJwtGuard = void 0;
const common_1 = __webpack_require__(6);
const passport_1 = __webpack_require__(10);
let ArtistJwtGuard = class ArtistJwtGuard extends (0, passport_1.AuthGuard)('jwt') {
    canActivate(context) {
    ...
    handleRequest(err, user) {
        ...
        throw err || new common_1.UnauthorizedException("Unable to find artist");
    }
};
exports.ArtistJwtGuard = ArtistJwtGuard;
exports.ArtistJwtGuard = ArtistJwtGuard = __decorate([
    (0, common_1.Injectable)()
], ArtistJwtGuard);
...
const auth_constants_1 = __webpack_require__(41);
const jwt_strategy_1 = __webpack_require__(42);
const artist_module_1 = __webpack_require__(44);
const passport_1 = __webpack_require__(10);
const api_key_strategy_1 = __webpack_require__(46);
    ...
    (0, common_1.Module)({
        imports: [
            ...
            jwt_1.JwtModule.register({
                secret: auth_constants_1.authConstants.secret,
                signOptions: {
                    expiresIn: '1d',
                },
            }),
...
const jwt_1 = __webpack_require__(32);
const artist_service_1 = __webpack_require__(33);
const speakeasy = __webpack_require__(34);
...
exports.ArtistService = ArtistService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_2.InjectRepository)(artist_entity_1.Artist)),
...
const auth_service_1 = __webpack_require__(28);
const auth_login_dto_1 = __webpack_require__(37);
const jwt_guard_1 = __webpack_require__(9);
const validate_token_dto_1 = __webpack_require__(38);
const passport_1 = __webpack_require__(10);
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_c = typeof create_user_dto_1.CreatUserDTO !== "undefined" && create_user_dto_1.CreatUserDTO) === "function" ? _c : Object]),
    __metadata("design:returntype", typeof (_d = typeof Promise !== "undefined" && Promise) === "function" ? _d : Object)
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_e = typeof auth_login_dto_1.LoginDTO !== "undefined" && auth_login_dto_1.LoginDTO) === "function" ? _e : Object]),
    __metadata("design:returntype", typeof (_f = typeof Promise !== "undefined" && Promise) === "function" ? _f : Object)
...
__decorate([
    ...
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_j = typeof validate_token_dto_1.ValidateTokenDTO !== "undefined" && validate_token_dto_1.ValidateTokenDTO) === "function" ? _j : Object, Object]),
...
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    constructor() {
        super({
            ...
            secretOrKey: auth_constants_1.authConstants.secret,
        });
    }
...
const artist_entity_1 = __webpack_require__(16);
const artist_service_1 = __webpack_require__(33);
const artist_controller_1 = __webpack_require__(45);
...
const common_1 = __webpack_require__(6);
const passport_1 = __webpack_require__(10);
const passport_http_bearer_1 = __webpack_require__(47);
const auth_service_1 = __webpack_require__(28);
let ApiKeyStrategy = class ApiKeyStrategy extends (0, passport_1.PassportStrategy)(passport_http_bearer_1.Strategy) {
...
const common_1 = __webpack_require__(6);
const playlist_service_1 = __webpack_require__(49);
const playlist_controller_1 = __webpack_require__(50);
const typeorm_1 = __webpack_require__(20);
const playlist_entity_1 = __webpack_require__(19);
const song_entity_1 = __webpack_require__(15);
const user_entity_1 = __webpack_require__(17);
...
const common_1 = __webpack_require__(6);
const seed_service_1 = __webpack_require__(55);
...
const common_1 = __webpack_require__(6);
const seed_data_1 = __webpack_require__(56);
const typeorm_1 = __webpack_require__(14);
...
const faker_1 = __webpack_require__(57);
const uuid_1 = __webpack_require__(30);
const bcrypt = __webpack_require__(31);
const user_entity_1 = __webpack_require__(17);
const artist_entity_1 = __webpack_require__(16);
...
__decorate([
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], EnvironmentVariables.prototype, "SECRET", void 0);
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("77285da8e7900e215251")
/******/ 	})();
/******/ 	
